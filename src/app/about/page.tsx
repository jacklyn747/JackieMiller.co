...
// The interview, verbatim from Jackie. `long` calms the size on explanatory
// answers; `accent` marks the single expressive line (identity hinge).
            ...
            {INTERVIEW.map((item, i) => (
              <li className="qa-row" key={i}>
                ...
                <div className="qa-body">
                  ...
                  <p className={`qa-a${item.long ? " is-long" : ""}${item.accent ? " is-accent" : ""}`}>
                    {item.a}
                  </p>
                </div>
              </li>
